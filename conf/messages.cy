...
problem_report.action.error.length=Mae rhaid i’r sylw fod yn 1000 o gymeriadau neu lai
...
contact.comments.error.length=Mae rhaid i’r sylw fod yn 2000 o gymeriadau neu lai
...
one_login_complaint.nino.label=Rhif Yswiriant Gwladol
one_login_complaint.nino.hint=Mae ar eich cerdyn Yswiriant Gwladol, llythyr budd-daliadau, slip cyflog neu P60 - er enghraifft, ''QQ 12 34 56 C''
one_login_complaint.nino.error=Nodwch rif Yswiriant Gwladol yn y fformat cywir
one_login_complaint.sa-utr.label=Cyfeirnod Unigryw y Trethdalwr (UTR) ar gyfer Hunanasesiad (dewisol)
one_login_complaint.sa-utr.hint=Bydd i’w weld yn eich Cyfrif Treth Personol, yn ap CThEF, neu ar Ffurflenni Treth a dogfennau eraill oddi wrth CThEF. Efallai y cyfeirir ato gan ddefnyddio’r geiriau ''cyfeirnod'', ''UTR'' neu ''defnydd swyddogol''.
one_login_complaint.sa-utr.error=Nodwch eich Cyfeirnod Unigryw y Trethdalwr ar gyfer Hunanasesiad yn y fformat cywir neu gadewch yn wag
one_login_complaint.date-of-birth.label=Dyddiad geni
one_login_complaint.date-of-birth.hint=Er enghraifft, 27 3 2024
one_login_complaint.date-of-birth.error.invalid=Mae’n rhaid i’r dyddiad geni fod yn ddyddiad go iawn
one_login_complaint.date-of-birth.error.day=Mae’n rhaid i’r dyddiad geni gynnwys diwrnod
one_login_complaint.date-of-birth.error.month=Mae’n rhaid i’r dyddiad geni gynnwys mis
one_login_complaint.date-of-birth.error.year=Mae’n rhaid i’r dyddiad geni gynnwys blwyddyn
one_login_complaint.date-of-birth.error.future=Mae’n rhaid i’ch dyddiad geni fod yn y gorffennol
one_login_complaint.email.label=Cyfeiriad e-bost
one_login_complaint.phone-number.label=Rhif ffôn (dewisol)
one_login_complaint.phone-number.error=Ni all y rhif ffôn fod yn hirach na 50 o gymeriadau
one_login_complaint.address.label=Beth yw’ch cyfeiriad?
one_login_complaint.address.hint=Rhowch eich cyfeiriad post llawn.
one_login_complaint.address.error=Nodwch eich cyfeiriad llawn
one_login_complaint.contact-preference.label=Sut yr hoffech i ni gysylltu â chi?
one_login_complaint.contact-preference.hint=Dewiswch un opsiwn
one_login_complaint.contact-preference.error=Mae’n rhaid i’r dewis cyswllt fod yn un o’r canlynol: E-bost, Galwad ffôn, Llythyr
one_login_complaint.radio.email.label=E-bost
one_login_complaint.radio.phone-call.label=Galwad ffôn
one_login_complaint.radio.letter-message.label=Llythyr
one_login_complaint.complaint.label=Cwyn (dewisol)
