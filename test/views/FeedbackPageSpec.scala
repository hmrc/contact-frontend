...
class FeedbackPageSpec extends BaseViewSpec {
  ...
  "the feedback page" should {
    val feedbackPage = instanceOf[FeedbackPage]
    ...
    "display the correct browser title" in {
      content.select("title").first().text shouldBe "Send your feedback – Contact HMRC – GOV.UK"
    }
    ...
    "include Error: in the title if errors occur" in {
      ...
      asDocument(contentWithErrors).title should be("Error: Send your feedback – Contact HMRC – GOV.UK")
    }
