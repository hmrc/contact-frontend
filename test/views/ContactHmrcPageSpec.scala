...
class ContactHmrcPageSpec extends BaseViewSpec {
  ...
  "the Contact Hmrc standalone page" should {
    val contactHmrcPage = instanceOf[ContactHmrcPage]
    ...
    "display the correct browser title" in {
      content.select("title").first().text shouldBe "Help and contact – Contact HMRC – GOV.UK"
    }
    ...
    "include Error: in the title if errors occur" in {
      ...
      asDocument(contentWithErrors).title should be("Error: Help and contact – Contact HMRC – GOV.UK")
    }
