...
object YtaConfig extends AppConfig with ServicesConfig {
  ...
  override lazy val reportAProblemPartialUrl: String = controllers.routes.ProblemReportsController.reportForm().url
